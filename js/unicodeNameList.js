...
(function() {
	var unicodeNameList = {
		...
		0x0080: '[control]',
		0x0081: '[control]',
		0x0082: '[control] BREAK PERMITTED HERE',
		0x0083: '[control] NO BREAK HERE',
		0x0084: '[control] * formerly known as INDEX',
		0x0085: '[control] NEXT LINE (NEL)',
		0x0086: '[control] START OF SELECTED AREA',
		0x0087: '[control] END OF SELECTED AREA',
		0x0088: '[control] CHARACTER TABULATION SET',
		0x0089: '[control] CHARACTER TABULATION WITH JUSTIFICATION',
		0x008A: '[control] LINE TABULATION SET',
		0x008B: '[control] PARTIAL LINE FORWARD',
		0x008C: '[control] PARTIAL LINE BACKWARD',
		0x008D: '[control] REVERSE LINE FEED',
		0x008E: '[control] SINGLE SHIFT TWO',
		0x008F: '[control] SINGLE SHIFT THREE',
		0x0090: '[control] DEVICE CONTROL STRING',
		0x0091: '[control] PRIVATE USE ONE',
		0x0092: '[control] PRIVATE USE TWO',
		0x0093: '[control] SET TRANSMIT STATE',
		0x0094: '[control] CANCEL CHARACTER',
		0x0095: '[control] MESSAGE WAITING',
		0x0096: '[control] START OF GUARDED AREA',
		0x0097: '[control] END OF GUARDED AREA',
		0x0098: '[control] START OF STRING',
		0x0099: '[control]',
		0x009A: '[control] SINGLE CHARACTER INTRODUCER',
		0x009B: '[control] CONTROL SEQUENCE INTRODUCER',
		0x009C: '[control] STRING TERMINATOR',
		0x009D: '[control] OPERATING SYSTEM COMMAND',
		0x009E: '[control] PRIVACY MESSAGE',
		0x009F: '[control] APPLICATION PROGRAM COMMAND',
	...
	this.getUnicodeName = function(codePoint) {
		...
		if (0xf900 <= codePoint && codePoint <= 0xfad9) {
			return 'CJK COMPATIBILITY IDEOGRAPH-' + getHexString(codePoint);
		}
		...
		if (0x2f800 <= codePoint && codePoint <= 0x2fa1d) {
			return 'CJK COMPATIBILITY IDEOGRAPH-' + getHexString(codePoint);
		}
